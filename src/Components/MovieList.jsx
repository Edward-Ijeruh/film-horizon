  ...
  return (
    <div className="bg-gray-900 text-white min-h-screen flex flex-col">
      ...
      <nav className="sticky top-0 bg-gray-900 shadow-lg z-50">
        ...
        <div
          className={`absolute top-14 right-4 bg-gray-800 rounded-lg shadow-lg transition-transform duration-300 p-4       space-y-2 sm:hidden 
        ...
        >
          ...
          <Link
            to="/watchlist"
            className="flex items-center text-white hover:text-red-600" // Updated to flex to align content
            onClick={() => setIsOpen(false)}
          >
            {/* Display "Watchlist" text with count */}
            Watchlist{" "}
              ...
              displayedMovies.map((movie) => (
                ...
                >
                  ...
                  <div className="p-3 sm:p-4">
                    <h3 className="text-white text-xs sm:text-xl font-semibold">
                      {movie.title}
                    </h3>
                  </div>
                </Link>
      ...
      <footer className="bg-gray-800 text-white text-center py-4 mt-8">
        {" "}
        <p>&copy; 2025 FilmHorizon. All rights reserved.</p>{" "}
      </footer>
    </div>
  );
};
